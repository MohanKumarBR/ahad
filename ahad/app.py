...
data = pickle.load( open( "ahad-main-data.pkl", "rb" ) )
words = data['words']
classes = data['classes']

with open('ahad.json') as json_data:
...
with open(f'ahad-main-model.pkl', 'rb') as f:
    model = pickle.load(f)
...
if __name__ == '__main__':
    ...
    app.run(debug=True, threaded=False, port= 9090, host="0.0.0.0")
